...
\section*{Introduction}
Long-range van der Waals (vdW) dispersion interactions between atoms and molecules, though typically characterized as ``weak'', underpin a great deal of physical and chemical behavior in biological and material science. %The intricacies of 
...
%MS: Physically, vdW interactions form the major part of long-range electron correlation and arise from instantaneous quantum-mechanical fluctuations in the electron density. As such they are inherently many-body in nature, which renders their accurate description a considerable challenge.
...
Coulomb singles can comprise an appreciable part %of the overall picture 
